...
import Screenshot4 from '../../assets/image/saasModern/correction.png';
import Screenshot2 from '../../assets/image/saasModern/automation.svg';
import Screenshot1 from '../../assets/image/saasModern/clientCreate.svg';
import Screenshot3 from '../../assets/image/saasModern/clientConnect.svg';
...
// under is the import for the icon 1
...
export const SCREENSHOTS = [
  {
    ...
    image: Screenshot1,
    description:'Vous créez un nouveau client et lui assigner des documents et une date limite. '
  },
  {
    icon: u0032,
    title: 'Le client se connecte',
    image: Screenshot3,
    description:'Le client se connecte sur son espace privé pour téléverser les documents dans les cases correspondantes.'
  },
  {
    icon: u0033,
    title: 'Suivi automatique',
    image: Screenshot2,
    description:"Le statut d’un dossier se met à jour automatiquement. \n Si le client ne soumet pas ses documents à temps, son statut devient rouge. Si il a tout soumis, c’est vert. \n Simple comme bonjour !"
  },
  {
    icon: u0034,
    title: 'Vérification du dossier',
    image: Screenshot4,
    description:"Quand tous les documents ont été téleversé, recevez un e-mail de notification. Il ne vous reste plus qu'à marquer les documents comme bon ou demander une correction des documents."
  },
];
