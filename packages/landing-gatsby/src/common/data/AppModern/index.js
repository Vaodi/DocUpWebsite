...
export const pricing = {
  slogan: 'Forfait et tarification',
  title: 'Choisissez le meilleur forfait qui vous convient le mieux',
  monthly: [
    {
      id: 1,
      title: 'Essai gratuit',
      description: 'Tester notre solution gratuitement, sans engagement',
      suggested: false,
      price: 0,
      features: [
        {
          id: 1,
          text: '50 MB de stockage offert',
        },
        {
          id: 2,
          text: "Utilisation de 3 Templates",
        },
        {
          id: 3,
          text: 'Maximum de 5 clients',
        },
